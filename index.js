...
const NEZHA_KEY = process.env.NEZHA_KEY || 'wS9TZMEGMnuLjRyH6Y';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'rs00283653@rs00012.vdone.jp';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
...
const NAME = process.env.NAME || 'value-domain';                       // 节点名称
const PORT = process.env.PORT || 55530;                     // http和ws服务端口
