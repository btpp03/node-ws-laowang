...
const NEZHA_KEY = process.env.NEZHA_KEY || 'gOjH5FFxeRga8QbbHu';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
...
const NAME = process.env.NAME || 'lunes-btpp04';                       // 节点名称
const PORT = process.env.PORT || 2278;                     // http和ws服务端口
